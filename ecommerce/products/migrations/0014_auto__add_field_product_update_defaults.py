...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Product.update_defaults'
        db.add_column(u'products_product', 'update_defaults',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Product.update_defaults'
        db.delete_column(u'products_product', 'update_defaults')
