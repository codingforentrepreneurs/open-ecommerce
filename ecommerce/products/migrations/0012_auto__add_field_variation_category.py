...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Variation.category'
        db.add_column(u'products_variation', 'category',
                      self.gf('django.db.models.fields.CharField')(default='size', max_length=120),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Variation.category'
        db.delete_column(u'products_variation', 'category')
