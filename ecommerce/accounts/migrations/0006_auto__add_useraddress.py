...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'accounts_useraddress', (
            ...
            ('address2', self.gf('django.db.models.fields.CharField')(max_length=120, null=True, blank=True)),
            ('city', self.gf('django.db.models.fields.CharField')(max_length=120)),
            ...
            ('shipping', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('billing', self.gf('django.db.models.fields.BooleanField')(default=False)),
